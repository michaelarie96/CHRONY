  ...
  const renderStep1 = () => (
    <div className="text-center">
      <div className="mb-6">
        ...
        <h2 className="text-2xl font-semibold text-gray-800 mb-2">Welcome to Chrony!</h2>
        <p className="text-gray-600">Let's set up your schedule preferences to get started</p>
      </div>

      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
        <h3 className="font-medium text-blue-800 mb-2">What are active hours?</h3>
      ...
      <div className="text-left">
        <h3 className="text-lg font-medium text-gray-700 mb-4">Set Your Active Hours</h3>
        ...
        <div className="bg-gray-50 rounded-lg p-3 mb-4">
          <p className="text-sm text-gray-600">
            ...
            <span className="ml-2 text-gray-500">({calculateActiveHours()} hours per day)</span>
          </p>
        </div>
      </div>
    </div>
  ...
  const renderStep2 = () => (
    <div className="text-center">
      <div className="mb-6">
        ...
        <h2 className="text-2xl font-semibold text-gray-800 mb-2">Choose Your Rest Day</h2>
        <p className="text-gray-600">Select the day when you want to avoid scheduling events</p>
      </div>
        ...
        <div className="space-y-3">
          <label className="flex items-center p-4 border-2 rounded-lg cursor-pointer hover:bg-gray-50 transition-colors">
            ...
            <div className="flex-1">
              ...
              <div className="text-xs text-gray-400 mt-1">Popular in Middle East, Some Asian countries</div>
            </div>
          </label>
          ...
          <label className="flex items-center p-4 border-2 rounded-lg cursor-pointer hover:bg-gray-50 transition-colors">
            ...
            <div className="flex-1">
              ...
              <div className="text-xs text-gray-400 mt-1">Popular in Western countries</div>
            </div>
          </label>
        </div>
  ...
  const renderStep3 = () => (
    <div className="text-center">
      <div className="mb-6">
        ...
        <p className="text-gray-600">Review your settings before we get started</p>
      </div>

      <div className="bg-white border border-gray-200 rounded-lg p-6 mb-6">
        <h3 className="font-medium text-gray-700 mb-4">Your Schedule Settings</h3>
        
        <div className="space-y-3 text-left">
          <div className="flex justify-between">
            <span className="text-gray-600">Active Hours:</span>
            <span className="font-medium">{formatTimeDisplay(activeStartTime)} - {formatTimeDisplay(activeEndTime)}</span>
          </div>
          ...
          <div className="flex justify-between">
            ...
            <span className="font-medium">{restDay === 'saturday' ? 'Saturday' : 'Sunday'}</span>
          </div>
        </div>
      </div>
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
        ...
        <p className="text-sm text-blue-700">
          You can start creating events and tracking time. Chrony will intelligently 
          schedule your flexible and fluid events within your active hours!
        </p>
      </div>
    </div>
  );
